...
export const ExploreCard: React.FC<ExploreCardProps> = ({ id, imgUrl, active, handleClick, index, title }) => {
    return (
        <motion.div
...
export const InsightCard: React.FC<InsightCardProps> = ({ imgUrl, title, subtitle, index }) => {
    return (
        <motion.div
